...
書籍は、先にまとめて買わない。最初に買うのは2冊だけにし、残りはそのステージの開始時に、その時点の最新版を確認して買う。各ユニットで読む章は、今後の版で順次追加する（[改訂の運用](30-revision.md)）。それまでは、各ユニットのページの「平日に読むもの」を手がかりに、目次から選ぶ。読む時間は、平日の火曜と木曜と、AIなしデーのメイン①の最初の30分（[AIなしデーの進め方](04-ai-free-day.md)）。
